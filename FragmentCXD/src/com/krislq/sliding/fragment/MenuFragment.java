...
public class MenuFragment extends PreferenceFragment implements OnPreferenceClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findPreference("menu_shouYe").setOnPreferenceClickListener(this);
        findPreference("menu_login").setOnPreferenceClickListener(this);
        findPreference("menu_sync").setOnPreferenceClickListener(this);
        findPreference("menu_car").setOnPreferenceClickListener(this);
        findPreference("menu_maintance").setOnPreferenceClickListener(this);
        findPreference("menu_weixin").setOnPreferenceClickListener(this);
        findPreference("menu_feedback").setOnPreferenceClickListener(this);
        findPreference("menu_business").setOnPreferenceClickListener(this);
        findPreference("menu_about").setOnPreferenceClickListener(this);
        findPreference("menu_cache").setOnPreferenceClickListener(this);
    }
